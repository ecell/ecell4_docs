...
RUN wget https://github.com/ecell/ecell4/releases/download/v4.0.1/ecell-4.0.1-cp35-cp35m-manylinux1_x86_64.whl; pip install ./ecell-4.0.1-cp35-cp35m-manylinux1_x86_64.whl
