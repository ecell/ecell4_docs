...
.. only:: html
   ...
   .. seealso::
      ...
      Download the `Jupyter Notebook <https://jupyter.org/>`_ for this section: :download:`{{ path.rsplit('/', 1)[1] }} </{{ path.replace('_notebooks', '_downloads') }}>`. `View in nbviewer <https://nbviewer.jupyter.org/github/kaizu/ecell4_docs/blob/{{ env.config.release|e }}/en/{{ path|e }}>`_.
